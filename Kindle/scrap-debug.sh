...
if [ ! -f "TheEconomist-$1-$2.mobi" ];then
        ...
        ebook-convert "TheEconomist-$1-$2.recipe" .mobi --output-profile=kindle_oasis --pubdate="$1" -d debug -vv --mobi-file-type=new --authors="TheEconomist" --title="TheEconomist-$1-$2"
